unit uFrmExplicacaoRuasExcessoOS;
...
uses
  ...
  dxSkinWhiteprint, dxSkinXmas2008Blue, cxTextEdit, cxMemo;

type
  TFrmExplicacaoRuasExcessoOS = class(TForm)
    mmQuery: TcxMemo;
...
var
  FrmExplicacaoRuasExcessoOS: TFrmExplicacaoRuasExcessoOS;
...
procedure TFrmExplicacaoRuasExcessoOS.FormShow(Sender: TObject);
begin

  mmQuery.Text := dmdb.qryRuasExcessoOS.SQL.Text;
