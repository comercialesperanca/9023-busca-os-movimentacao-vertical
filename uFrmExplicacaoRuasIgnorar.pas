unit uFrmExplicacaoRuasIgnorar;
...
uses
  ...
  dxSkinWhiteprint, dxSkinXmas2008Blue, cxTextEdit, cxMemo, cxLabel;

type
  TFrmExplicacaoRuasIgnorar = class(TForm)
    mmPaleteiros: TcxMemo;
    mmEmpilhadores: TcxMemo;
    cxLabel1: TcxLabel;
    cxLabel2: TcxLabel;
...
var
  FrmExplicacaoRuasIgnorar: TFrmExplicacaoRuasIgnorar;
...
procedure TFrmExplicacaoRuasIgnorar.FormShow(Sender: TObject);
begin

  mmPaleteiros.Text := dmdb.qryRuasExcessoFuncionariosPalet.SQL.Text;
  mmEmpilhadores.Text := dmdb.qryRuasExcessoFuncionariosEmp.SQL.Text;
